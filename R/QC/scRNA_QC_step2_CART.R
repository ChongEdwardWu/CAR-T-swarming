#!/usr/bin/env Rscript
# scRNA-seq QC Step 2 — per-sample script (PostCAR example)
...
#   export SAMPLE="PostCAR"          # or "PostCC5"
#   export SPECIES="hs"               # or "mm"
#   export PROJECT_BASE="."
#   export WORK_BASE="03_R/QC"
#   export CR_PATH="/path/to/02_CRcount/PostCAR/outs/filtered_feature_bc_matrix"
...
SAMPLE              <- Sys.getenv("SAMPLE", unset = "PostCAR")
...
# Optional: add velocity assays from .loom
...
# Optional: human PBMC annotation via Azimuth if reference is provided
